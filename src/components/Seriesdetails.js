...
function Seriesdetails({ match }) {
  ...
  const { error, loading, items } = useMovies(
    `https://api.themoviedb.org/3/tv/${checkparams}?api_key=07a87afa9594ed4d43e740c14f0f5651`
  );
      ...
      <div className="overview-details">
        <div className="overview-header">
          ...
          <a
            ...
            href={`https://www.youtube.com/results?search_query=${item.name} trailer`}
            target="_blank"
